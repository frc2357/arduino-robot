...
// $Id: RFM_95C.h,v 1.21 2017/11/06 00:04:08 mikem Exp $
//
...
#define RFM_95C_NUM_INTERRUPTS 2

// Max number of octets the LORA Rx/Tx FIFO can hold
#define RFM_95C_FIFO_SIZE 255

// This is the maximum number of bytes that can be carried by the LORA.
// We use some for headers, keeping fewer for RadioHead messages
#define RFM_95C_MAX_PAYLOAD_LEN RFM_95C_FIFO_SIZE
...
#ifndef RFM_95C_MAX_MESSAGE_LEN
#define RFM_95C_MAX_MESSAGE_LEN (RFM_95C_MAX_PAYLOAD_LEN - RFM_95C_HEADER_LEN)
#endif

// The crystal oscillator frequency of the module
#define RFM_95C_FXOSC 32000000.0

// The Frequency Synthesizer step = RFM_95C_FXOSC / 2^^19
#define RFM_95C_FSTEP (RFM_95C_FXOSC / 524288)

// Register names (LoRa Mode, from table 85)
#define RFM_95C_REG_00_FIFO 0x00
#define RFM_95C_REG_01_OP_MODE 0x01
#define RFM_95C_REG_02_RESERVED 0x02
#define RFM_95C_REG_03_RESERVED 0x03
#define RFM_95C_REG_04_RESERVED 0x04
#define RFM_95C_REG_05_RESERVED 0x05
#define RFM_95C_REG_06_FRF_MSB 0x06
#define RFM_95C_REG_07_FRF_MID 0x07
#define RFM_95C_REG_08_FRF_LSB 0x08
#define RFM_95C_REG_09_PA_CONFIG 0x09
#define RFM_95C_REG_0A_PA_RAMP 0x0a
#define RFM_95C_REG_0B_OCP 0x0b
#define RFM_95C_REG_0C_LNA 0x0c
#define RFM_95C_REG_0D_FIFO_ADDR_PTR 0x0d
#define RFM_95C_REG_0E_FIFO_TX_BASE_ADDR 0x0e
#define RFM_95C_REG_0F_FIFO_RX_BASE_ADDR 0x0f
#define RFM_95C_REG_10_FIFO_RX_CURRENT_ADDR 0x10
#define RFM_95C_REG_11_IRQ_FLAGS_MASK 0x11
#define RFM_95C_REG_12_IRQ_FLAGS 0x12
#define RFM_95C_REG_13_RX_NB_BYTES 0x13
#define RFM_95C_REG_14_RX_HEADER_CNT_VALUE_MSB 0x14
#define RFM_95C_REG_15_RX_HEADER_CNT_VALUE_LSB 0x15
#define RFM_95C_REG_16_RX_PACKET_CNT_VALUE_MSB 0x16
#define RFM_95C_REG_17_RX_PACKET_CNT_VALUE_LSB 0x17
#define RFM_95C_REG_18_MODEM_STAT 0x18
#define RFM_95C_REG_19_PKT_SNR_VALUE 0x19
#define RFM_95C_REG_1A_PKT_RSSI_VALUE 0x1a
#define RFM_95C_REG_1B_RSSI_VALUE 0x1b
#define RFM_95C_REG_1C_HOP_CHANNEL 0x1c
#define RFM_95C_REG_1D_MODEM_CONFIG1 0x1d
#define RFM_95C_REG_1E_MODEM_CONFIG2 0x1e
#define RFM_95C_REG_1F_SYMB_TIMEOUT_LSB 0x1f
#define RFM_95C_REG_20_PREAMBLE_MSB 0x20
#define RFM_95C_REG_21_PREAMBLE_LSB 0x21
#define RFM_95C_REG_22_PAYLOAD_LENGTH 0x22
#define RFM_95C_REG_23_MAX_PAYLOAD_LENGTH 0x23
#define RFM_95C_REG_24_HOP_PERIOD 0x24
#define RFM_95C_REG_25_FIFO_RX_BYTE_ADDR 0x25
#define RFM_95C_REG_26_MODEM_CONFIG3 0x26

#define RFM_95C_REG_27_PPM_CORRECTION 0x27
#define RFM_95C_REG_28_FEI_MSB 0x28
#define RFM_95C_REG_29_FEI_MID 0x29
#define RFM_95C_REG_2A_FEI_LSB 0x2a
#define RFM_95C_REG_2C_RSSI_WIDEBAND 0x2c
#define RFM_95C_REG_31_DETECT_OPTIMIZ 0x31
#define RFM_95C_REG_33_INVERT_IQ 0x33
#define RFM_95C_REG_37_DETECTION_THRESHOLD 0x37
#define RFM_95C_REG_39_SYNC_WORD 0x39

#define RFM_95C_REG_40_DIO_MAPPING1 0x40
#define RFM_95C_REG_41_DIO_MAPPING2 0x41
#define RFM_95C_REG_42_VERSION 0x42

#define RFM_95C_REG_4B_TCXO 0x4b
#define RFM_95C_REG_4D_PA_DAC 0x4d
#define RFM_95C_REG_5B_FORMER_TEMP 0x5b
#define RFM_95C_REG_61_AGC_REF 0x61
#define RFM_95C_REG_62_AGC_THRESH1 0x62
#define RFM_95C_REG_63_AGC_THRESH2 0x63
#define RFM_95C_REG_64_AGC_THRESH3 0x64

// RFM_95C_REG_01_OP_MODE                             0x01
#define RFM_95C_LONG_RANGE_MODE 0x80
#define RFM_95C_ACCESS_SHARED_REG 0x40
#define RFM_95C_LOW_FREQUENCY_MODE 0x08
#define RFM_95C_MODE 0x07
#define RFM_95C_MODE_SLEEP 0x00
#define RFM_95C_MODE_STDBY 0x01
#define RFM_95C_MODE_FSTX 0x02
#define RFM_95C_MODE_TX 0x03
#define RFM_95C_MODE_FSRX 0x04
#define RFM_95C_MODE_RXCONTINUOUS 0x05
#define RFM_95C_MODE_RXSINGLE 0x06
#define RFM_95C_MODE_CAD 0x07

// RFM_95C_REG_09_PA_CONFIG                           0x09
#define RFM_95C_PA_SELECT 0x80
#define RFM_95C_MAX_POWER 0x70
#define RFM_95C_OUTPUT_POWER 0x0f

// RFM_95C_REG_0A_PA_RAMP                             0x0a
#define RFM_95C_LOW_PN_TX_PLL_OFF 0x10
#define RFM_95C_PA_RAMP 0x0f
#define RFM_95C_PA_RAMP_3_4MS 0x00
#define RFM_95C_PA_RAMP_2MS 0x01
#define RFM_95C_PA_RAMP_1MS 0x02
#define RFM_95C_PA_RAMP_500US 0x03
#define RFM_95C_PA_RAMP_250US 0x0
#define RFM_95C_PA_RAMP_125US 0x05
#define RFM_95C_PA_RAMP_100US 0x06
#define RFM_95C_PA_RAMP_62US 0x07
#define RFM_95C_PA_RAMP_50US 0x08
#define RFM_95C_PA_RAMP_40US 0x09
#define RFM_95C_PA_RAMP_31US 0x0a
#define RFM_95C_PA_RAMP_25US 0x0b
#define RFM_95C_PA_RAMP_20US 0x0c
#define RFM_95C_PA_RAMP_15US 0x0d
#define RFM_95C_PA_RAMP_12US 0x0e
#define RFM_95C_PA_RAMP_10US 0x0f

// RFM_95C_REG_0B_OCP                                 0x0b
#define RFM_95C_OCP_ON 0x20
#define RFM_95C_OCP_TRIM 0x1f

// RFM_95C_REG_0C_LNA                                 0x0c
#define RFM_95C_LNA_GAIN 0xe0
#define RFM_95C_LNA_GAIN_G1 0x20
#define RFM_95C_LNA_GAIN_G2 0x40
#define RFM_95C_LNA_GAIN_G3 0x60
#define RFM_95C_LNA_GAIN_G4 0x80
#define RFM_95C_LNA_GAIN_G5 0xa0
#define RFM_95C_LNA_GAIN_G6 0xc0
#define RFM_95C_LNA_BOOST_LF 0x18
#define RFM_95C_LNA_BOOST_LF_DEFAULT 0x00
#define RFM_95C_LNA_BOOST_HF 0x03
#define RFM_95C_LNA_BOOST_HF_DEFAULT 0x00
#define RFM_95C_LNA_BOOST_HF_150PC 0x11

// RFM_95C_REG_11_IRQ_FLAGS_MASK                      0x11
#define RFM_95C_RX_TIMEOUT_MASK 0x80
#define RFM_95C_RX_DONE_MASK 0x40
#define RFM_95C_PAYLOAD_CRC_ERROR_MASK 0x20
#define RFM_95C_VALID_HEADER_MASK 0x10
#define RFM_95C_TX_DONE_MASK 0x08
#define RFM_95C_CAD_DONE_MASK 0x04
#define RFM_95C_FHSS_CHANGE_CHANNEL_MASK 0x02
#define RFM_95C_CAD_DETECTED_MASK 0x01

// RFM_95C_REG_12_IRQ_FLAGS                           0x12
#define RFM_95C_RX_TIMEOUT 0x80
#define RFM_95C_RX_DONE 0x40
#define RFM_95C_PAYLOAD_CRC_ERROR 0x20
#define RFM_95C_VALID_HEADER 0x10
#define RFM_95C_TX_DONE 0x08
#define RFM_95C_CAD_DONE 0x04
#define RFM_95C_FHSS_CHANGE_CHANNEL 0x02
#define RFM_95C_CAD_DETECTED 0x01

// RFM_95C_REG_18_MODEM_STAT                          0x18
#define RFM_95C_RX_CODING_RATE 0xe0
#define RFM_95C_MODEM_STATUS_CLEAR 0x10
#define RFM_95C_MODEM_STATUS_HEADER_INFO_VALID 0x08
#define RFM_95C_MODEM_STATUS_RX_ONGOING 0x04
#define RFM_95C_MODEM_STATUS_SIGNAL_SYNCHRONIZED 0x02
#define RFM_95C_MODEM_STATUS_SIGNAL_DETECTED 0x01

// RFM_95C_REG_1C_HOP_CHANNEL                         0x1c
#define RFM_95C_PLL_TIMEOUT 0x80
#define RFM_95C_RX_PAYLOAD_CRC_IS_ON 0x40
#define RFM_95C_FHSS_PRESENT_CHANNEL 0x3f

// RFM_95C_REG_1D_MODEM_CONFIG1                       0x1d
#define RFM_95C_BW 0xf0

#define RFM_95C_BW_7_8KHZ 0x00
#define RFM_95C_BW_10_4KHZ 0x10
#define RFM_95C_BW_15_6KHZ 0x20
#define RFM_95C_BW_20_8KHZ 0x30
#define RFM_95C_BW_31_25KHZ 0x40
#define RFM_95C_BW_41_7KHZ 0x50
#define RFM_95C_BW_62_5KHZ 0x60
#define RFM_95C_BW_125KHZ 0x70
#define RFM_95C_BW_250KHZ 0x80
#define RFM_95C_BW_500KHZ 0x90
#define RFM_95C_CODING_RATE 0x0e
#define RFM_95C_CODING_RATE_4_5 0x02
#define RFM_95C_CODING_RATE_4_6 0x04
#define RFM_95C_CODING_RATE_4_7 0x06
#define RFM_95C_CODING_RATE_4_8 0x08
#define RFM_95C_IMPLICIT_HEADER_MODE_ON 0x01

// RFM_95C_REG_1E_MODEM_CONFIG2                       0x1e
#define RFM_95C_SPREADING_FACTOR 0xf0
#define RFM_95C_SPREADING_FACTOR_64CPS 0x60
#define RFM_95C_SPREADING_FACTOR_128CPS 0x70
#define RFM_95C_SPREADING_FACTOR_256CPS 0x80
#define RFM_95C_SPREADING_FACTOR_512CPS 0x90
#define RFM_95C_SPREADING_FACTOR_1024CPS 0xa0
#define RFM_95C_SPREADING_FACTOR_2048CPS 0xb0
#define RFM_95C_SPREADING_FACTOR_4096CPS 0xc0
#define RFM_95C_TX_CONTINUOUS_MOE 0x08

#define RFM_95C_PAYLOAD_CRC_ON 0x04
#define RFM_95C_SYM_TIMEOUT_MSB 0x03

// RFM_95C_REG_4B_TCXO                                0x4b
#define RFM_95C_TCXO_TCXO_INPUT_ON 0x10

// RFM_95C_REG_4D_PA_DAC                              0x4d
#define RFM_95C_PA_DAC_DISABLE 0x04
#define RFM_95C_PA_DAC_ENABLE 0x07

/////////////////////////////////////////////////////////////////////
/// \class RFM_95C RFM_95C.h <RFM_95C.h>
...
/// \par Packet Format
///
/// All messages sent and received by this RFM_95C Driver conform to this packet format:
///
/// - LoRa mode:
/// - 8 symbol PREAMBLE
...
/// \endcode
/// With these connections, you can then use the default constructor RFM_95C().
/// You can override the default settings for the SS pin and the interrupt in
/// the RFM_95C constructor if you wish to connect the slave select SS to other
...
/// #include <SPI.h>
/// #include <RFM_95C.h>
/// RFM_95C rf95(5, 2); // Rocket Scream Mini Ultra Pro with the RFM95W
/// #define Serial SerialUSB
///
/// void setup()
/// {
...
/// \par Interrupts
///
/// The RFM_95C driver uses interrupts to react to events in the RFM module,
/// such as the reception of a new packet, or the completion of transmission
/// of a packet.  The RFM_95C driver interrupt service routine reads status from
/// and writes data to the the RFM module via the SPI interface. It is very
/// important therefore, that if you are using the RFM_95C driver with another
...
/// \par Memory
///
/// The RFM_95C driver requires non-trivial amounts of memory. The sample
...
/// programs that use the RFM_95C driver.
///
...
/// with the RFM_95C::setTxPower() function. The argument can be any of
...
class RFM_95C : public RHSPIDriver
{
public:
    ...
    typedef struct
    {
        uint8_t reg_1d; ///< Value for register RFM_95C_REG_1D_MODEM_CONFIG1
        uint8_t reg_1e; ///< Value for register RFM_95C_REG_1E_MODEM_CONFIG2
        uint8_t reg_26; ///< Value for register RFM_95C_REG_26_MODEM_CONFIG3
    } ModemConfig;
    ...
    RFM_95C(uint8_t slaveSelectPin = SS, uint8_t interruptPin = 2, RHGenericSPI &spi = hardware_spi);
    ...
    /// Sets the message preamble length in RFM_95C_REG_??_PREAMBLE_?SB
    ...
    /// register RFM_95C_REG_1D_MODEM_CONFIG1 is invalid, returns 0.
    int frequencyError();
...
protected:
    /// This is a low level function to handle the interrupts for one instance of RFM_95C.
...
private:
    ...
    static RFM_95C *_deviceForInterrupt[];
    ...
    uint8_t _buf[RFM_95C_MAX_PAYLOAD_LEN];
